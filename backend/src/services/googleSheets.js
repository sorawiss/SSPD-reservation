...
console.log('GOOGLE_TYPE:', process.env.GOOGLE_TYPE ? 'SET' : 'NOT SET');
...
class GoogleSheetsService {
  ...
  static async getAllBookings() {
    try {
      ...
      console.log('Response received:', response.data ? 'SUCCESS' : 'NO DATA');
      
      if (!response.data.values) {
        console.log('No values found, returning empty array');
        return [];
      }

      console.log(`Found ${response.data.values.length} bookings`);
      ...
      // For development/testing, return empty array if Google Sheets is not available
      if (process.env.NODE_ENV === 'development') {
        console.log('Development mode: Returning empty array due to Google Sheets error');
        return [];
      }
