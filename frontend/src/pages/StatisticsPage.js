        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <div className="card">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <h2 className="text-xl font-semibold text-gray-800">การใช้งานห้องประชุม</h2>
            </div>
            ...
            {roomUtilizationChartData.length > 0 ? (
              ...
              <div className="text-center py-8">
                <p className="text-gray-500">ไม่มีข้อมูลการใช้งาน</p>
              </div>
            )}
          </div>
          ...
          <div className="card">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <h2 className="text-xl font-semibold text-gray-800">ช่วงเวลาที่มีการใช้งานห้องประชุมมากที่สุด</h2>
            </div>
            ...
            {peakHoursChartData.length > 0 ? (
              ...
              <div className="text-center py-8">
                <p className="text-gray-500">ไม่มีข้อมูลช่วงเวลาที่มีการใช้งานห้องประชุมมากที่สุด</p>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="card">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <h2 className="text-xl font-semibold text-gray-800">สรุปข้อมูล</h2>
            </div>
            
            <div className="space-y-4">
              <div className="bg-cyan-50 p-4 rounded-lg">
                <h3 className="font-semibold text-cyan-800 mb-2">ห้องประชุมที่มีการใช้งานมากที่สุด</h3>
              ...
              <div className="bg-green-50 p-4 rounded-lg">
                <h3 className="font-semibold text-green-800 mb-2">ช่วงเวลาที่มีการใช้งานห้องประชุมมากที่สุด</h3>
              ...
              <div className="bg-amber-50 p-4 rounded-lg">
                <h3 className="font-semibold text-amber-800 mb-2">การใช้งานห้องประชุมทั้งหมด</h3>
