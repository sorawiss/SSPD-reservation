...
export default function MyBookingsPage() {
  ...
  const fetchBookings = async (empId) => {
    ...
    setLoading(true);
    try {
      const data = await bookingsAPI.getBookings({ employeeId: empId });
  ...
  return (
    <div className="min-h-screen" style={{ background: 'linear-gradient(135deg, #f0fdf4 0%, #ffffff 100%)' }}>
      ...
      <div className="container mx-auto px-4 pb-8">
        {/* Employee ID Input */}
        {!employeeId && (
          <div className="card mb-8" style={{ maxWidth: '28rem', margin: '0 auto 2rem auto' }}>
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-4">
                กรอกรหัสพนักงานของคุณเพื่อดูการจองของคุณ
              </p>
              <div className="flex space-x-2">
                ...
                <button
                  onClick={() => {
                    const input = document.querySelector('input[placeholder="Employee ID"]');
                    if (input?.value) {
          ...
          <>
            ...
            <div className="card mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                  <label className="form-label">ห้องประชุม</label>
                  <select
                    value={filters.room}
